...
export function MetamaskBlack(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#metamask_black_svg__a)">
        <path fill="#000" d="M0 0h512v512H0z" />
        <g clipPath="url(#metamask_black_svg__b)">
          <path
            fill="#ff5c16"
      ...
      <defs>
        <clipPath id="metamask_black_svg__a">
          <path fill="#fff" d="M0 0h512v512H0z" />
        </clipPath>
        <clipPath id="metamask_black_svg__b">
