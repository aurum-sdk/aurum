...
export function PhantomBrand(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#phantom_brand_svg__a)">
        <path fill="#ab9ff2" d="M0 0h512v512H0z" />
        <path
          fill="#fff"
      ...
      <defs>
        <clipPath id="phantom_brand_svg__a">
