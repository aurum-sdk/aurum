...
export interface AurumBrandProps extends SVGProps<SVGSVGElement> {
  /** Optional color override for the hood path */
  color?: string;
}

export function AurumBrand({ color, ...props }: AurumBrandProps) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#aurum_brand_svg__a)">
      ...
      <defs>
        ...
        <clipPath id="aurum_brand_svg__a">
