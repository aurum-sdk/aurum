...
export interface AurumBlackProps extends SVGProps<SVGSVGElement> {
  /** Optional color override for the hood path */
  color?: string;
}

export function AurumBlack({ color, ...props }: AurumBlackProps) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#aurum_black_svg__a)">
      ...
      <defs>
        ...
        <clipPath id="aurum_black_svg__a">
