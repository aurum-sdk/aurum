...
export function WalletconnectBrand(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#walletconnect_brand_svg__a)">
        <path fill="#3396ff" d="M0 0h512v512H0z" />
        <path
          fill="#fff"
      ...
      <defs>
        <clipPath id="walletconnect_brand_svg__a">
