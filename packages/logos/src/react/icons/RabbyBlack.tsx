...
export function RabbyBlack(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#rabby_black_svg__a)">
      ...
      <defs>
        ...
        >
          ...
          <stop offset={0.984} stopColor="#6277f1" />
        </linearGradient>
        <clipPath id="rabby_black_svg__a">
