...
export interface AurumWhiteProps extends SVGProps<SVGSVGElement> {
  /** Optional color override for the hood path */
  color?: string;
}

export function AurumWhite({ color, ...props }: AurumWhiteProps) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#aurum_white_svg__a)">
      ...
      <defs>
        ...
        <clipPath id="aurum_white_svg__a">
          <path fill="#fff" d="M0 0h512v512H0z" />
        </clipPath>
      </defs>
    </svg>
